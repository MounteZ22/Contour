...
import type { AskUserQuestion } from '@contour/shared';
...
/** AskUser 单个问题的结构（跨端契约，见 @contour/shared） */
export type AskUserQuestionItem = AskUserQuestion;
/** AskUser 选项（跨端契约，见 @contour/shared） */
export type { AskUserOption } from '@contour/shared';
